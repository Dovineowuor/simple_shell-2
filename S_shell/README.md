...
This is simple shell project, made in a team of two. our main aim is to make it simple as the name suggest.
...
here are the f allowed unctions and system calls
execve (man 2 execve)
exit (man 3 exit)
_exit (man 2 _exit)
fflush (man 3 fflush)
